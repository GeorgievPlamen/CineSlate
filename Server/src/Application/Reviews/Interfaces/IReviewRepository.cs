...
public interface IReviewRepository
{
    ...
    public Task<Paged<Review>> GetReviewsByAuthorIdAsync(UserId userId, int page, int count, CancellationToken cancellationToken);
    ...
    public Task<bool> DeleteAsync(ReviewId reviewId, CancellationToken cancellationToken);
}
